...
def pre_processing(path):
    ...
    expertise_map = {
        'Beginner (I cannot ride on a board)': 0,
        'Novice (I can push around)': 2,
        'Intermediate (I can occasionally land simple tricks)': 4,
        'Advanced (I can occasionally land complex tricks)': 6,
